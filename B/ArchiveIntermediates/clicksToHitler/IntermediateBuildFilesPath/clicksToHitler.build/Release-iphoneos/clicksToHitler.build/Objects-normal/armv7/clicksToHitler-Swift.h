...
@interface ClicksViewController : UIViewController <UIWebViewDelegate>
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified clicksLabel;
- (IBAction)touched:(id _Nonnull)sender;
